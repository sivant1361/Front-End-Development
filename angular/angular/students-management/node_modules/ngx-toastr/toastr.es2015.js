...
class ToastrService {
    ...
    constructor(toastrConfig, overlay, _injector, sanitizer) {
        ...
        this.toastrConfig = new DefaultGlobalConfig();
        this.index = 0;
    ...
    applyConfig(override = {}) {
        ...
        const /** @type {?} */ current = Object.assign({}, this.toastrConfig);
        for (const /** @type {?} */ property of Object.keys(current)) {
            override[property] = use(override[property], current[property]);
        }
        const /** @type {?} */ asGlobalConfig = (override);
        if (asGlobalConfig.iconClasses) {
            const /** @type {?} */ currentIconClasses = (current.iconClasses);
            for (const /** @type {?} */ property of Object.keys(currentIconClasses)) {
